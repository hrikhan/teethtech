# Agent guide — teethtech

## Project

**teethtech** — Production-ready Flutter scaffold generated by the wizard.
...
Also update `lib/src/app.dart`, `.env`, `flutter_native_splash.yaml`, app icons, and native display name/package settings as needed. Keep `teethtech` and `com.template.app` only in the reusable template repo, not in real apps.
...
- Primary import barrel: `package:teethtech/src/imports/imports.dart`.
